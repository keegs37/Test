...
For capture cards, select **CAPTURE** in the Capture Method menu and set the card index/resolution in the Capture Controls section (use index 0 for the first card).
